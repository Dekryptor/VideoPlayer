...
class VideoGrid
{
	...
	public function create($videos,$title,$showFilter)
	{
		...
		{
			$gridItems = $this->generateItemsFromVidoes($videos);
		}
	...
	{
		$query = $this->con->prepare("SELECT * FROM videos ORDER BY RAND() LIMIT 35");
		$query->execute();
	...
	public function generateItemsFromVidoes($videos)
	{
		$elementHTML = "";
