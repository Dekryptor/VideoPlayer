<?php 
	require_once("includes/classes/VideoInfoControls.php");
		require_once("includes/classes/InputVideo.php");
 ...
 public function create()
	{
		...
		$controls = $VideoInfoControls->create();
 		...
 		return "<div class = 'videoInfo'>
 					...
 					<div class = 'bottomSection'>
 						<span class = 'viewCount'>$views veiws</span>
 						$controls
 					</div>
 				</div>";
 	}
 	...
 	private function createSecondaryInfo()
 	{
 		...
 		{
 			$userToIdObject = new InputVideo($this->con, $uploadedBy);
 			$userToObject = new User($this->con,$uploadedBy);
 			$actionButton = ButtonProvider::createSubscriberButton($this->con,$userToIdObject,$userToObject,$this->userLoggedInObj);
 		}
